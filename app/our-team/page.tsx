...
const TeamSection = () => {
  ...
  const teamMembers: TeamMember[] = [
    ...
    },
    {
      ...
      image: "/tathagat_image.png",
    },
    {
      name: "Ritik Sharma",
      role: "Full Stack Developer",
      description:
        "An experienced full stack developer proficient in modern web technologies. Specializes in building scalable, user-friendly applications with focus on performance and clean code.",
      image: "/ritik_image.jpg",
    },
    {
      name: "Arsh Charath",
      role: "Design Head",
      description:
        "Creative design leader with expertise in UI/UX principles and visual storytelling. Passionate about creating intuitive and aesthetically pleasing digital experiences that enhance user engagement.",
      image: "/arsh_image.jpg",
    },
  ];
    ...
    <div className="bg-gradient-to-b from-gray-50 to-gray-100 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          ...
          >
            Passionate experts driving innovation and excellence in every project.
          </motion.p>
        </div>
              ...
              <div className="p-6">
                ...
                <div className="mt-4">
                  ...
                  <button
                    ...
                    className="mt-3 text-indigo-600 font-medium hover:text-indigo-500 transition-colors duration-200 flex items-center"
                  >
                    {activeIndex === index ? 'Read less' : 'Read more'}
                    <svg 
                      className={`ml-1 h-4 w-4 transform transition-transform duration-200 ${activeIndex === index ? 'rotate-180' : ''}`} 
                      fill="currentColor" 
                      viewBox="0 0 20 20"
                    >
